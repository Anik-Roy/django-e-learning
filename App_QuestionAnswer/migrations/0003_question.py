...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('App_QuestionAnswer', '0002_delete_question'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category_questions', to='App_Article.category')),
